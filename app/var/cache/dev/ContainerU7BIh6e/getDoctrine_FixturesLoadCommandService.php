...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\ItemFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ToDoListServiceFixtures(($container->privates['mailer.mailer'] ?? $container->load('getMailer_MailerService'))), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\UserFixtures(), 'groups' => []]]);
