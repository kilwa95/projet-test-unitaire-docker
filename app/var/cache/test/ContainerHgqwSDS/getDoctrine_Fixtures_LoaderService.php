...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addFixtures([0 => ['fixture' => ($container->privates['App\\DataFixtures\\ItemFixtures'] ?? ($container->privates['App\\DataFixtures\\ItemFixtures'] = new \App\DataFixtures\ItemFixtures())), 'groups' => []], 1 => ['fixture' => ($container->privates['App\\DataFixtures\\ToDoListServiceFixtures'] ?? $container->load('getToDoListServiceFixturesService')), 'groups' => []], 2 => ['fixture' => ($container->privates['App\\DataFixtures\\UserFixtures'] ?? ($container->privates['App\\DataFixtures\\UserFixtures'] = new \App\DataFixtures\UserFixtures())), 'groups' => []]]);
