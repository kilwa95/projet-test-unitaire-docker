 ...
 */
class getToDoListServiceFixturesService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\DataFixtures\ToDoListServiceFixtures' shared autowired service.
     *
     * @return \App\DataFixtures\ToDoListServiceFixtures
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ToDoListServiceFixtures.php';

        return $container->privates['App\\DataFixtures\\ToDoListServiceFixtures'] = new \App\DataFixtures\ToDoListServiceFixtures(($container->privates['mailer.mailer'] ?? $container->load('getMailer_MailerService')));
    }
}
